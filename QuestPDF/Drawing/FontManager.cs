...
namespace QuestPDF.Drawing
{
    public static class FontManager
    {
        ...
        public static void RegisterFontFromEmbeddedResource(string pathName)
        {
            ...
            // Console.WriteLine(resourceNames.Length);

            using Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream(pathName);
            // RegisterFont(stream);
        }
        ...
        private static void RegisterLibraryDefaultFonts()
        {
            ...
            fontFileNames
                ...
                .ToList()
                .ForEach( path => RegisterFontFromEmbeddedResource(path));
        }
